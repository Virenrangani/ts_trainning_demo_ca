    ...
    return DefaultTabController(
      ...
      child: Scaffold(
        ...
        body: Padding(
          ...
          child: Column(
            children: [
              CustomFormField(labelText: CustomString.search, hintText: CustomString.searchItem,borderColor:CustomColor.info,),
              SizedBox(height:12,),
              Expanded(
                child: TabBarView(
                  children: [
                    Center(child: ProductPage()),
                    Center(child: Text("Fashion Page")),
                    Center(child: Text("Mobile Page")),
                    Center(child: Text("Beauty Page")),
                    Center(child: Text("Home Page")),
                    Center(child: Text("Appliances Page")),
                    Center(child: Text("Toy Page")),
